...
class Review(models.Model):
    ...
    review_period_start_date = models.DateField(u"Review Period Start", blank=True)
    review_period_end_date = models.DateField(u"Review Period End", blank=True)
    enjoyable_aspects = models.TextField(u"Enjoyable Aspects", blank=True, help_text='What was enjoyable about working towards this goal?')
    difficult_aspects = models.TextField(u"Difficult Aspects", blank=True, help_text='What was difficult about working towards this goal?')
    overcome_difficult_aspects = models.TextField(u"Overcome Difficult Aspects", blank=True, help_text='What worked to overcome the difficulties')
